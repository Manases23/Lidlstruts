...
<body>
	...
	<p id="enhorabuena">
		...
		¡Enhorabuena
		<%=session.getAttribute("dato")%>! Ha entrado usted en su cuenta
	</p>
...
%>
	...
	<div class="container text-center">
		<div class="row">
			...
			<a href="pedidoController?id_producto=<%=rs.getString("id")%>"><button type="button" class="btn" ;">Añadir a Mi cesta <span class="glyphicon glyphicon-shopping-cart"></span></button></a>
			
			<p><img class="col-sm-12" src="img/<%=rs.getString("imagen")%>"></p>
		</div>
